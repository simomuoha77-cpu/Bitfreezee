...
function parseOdds(raw) {
  ...
  if (direct && typeof direct === 'object') {
    ...
    if ([o.home, o.draw, o.away].every(Number.isFinite)) return { home: o.home, homeWin: o.home, draw: o.draw, away: o.away, awayWin: o.away };
  }
  ...
  for (const market of markets) {
    ...
    if ([result.home, result.draw, result.away].every(Number.isFinite)) return { home: result.home, homeWin: result.home, draw: result.draw, away: result.away, awayWin: result.away };
  }
  return null;
}
